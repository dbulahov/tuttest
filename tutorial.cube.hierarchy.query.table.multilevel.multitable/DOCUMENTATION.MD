# Documentation
### CatalogName : Hierarchy - Query - 1 Table, 2 Levels
### Schema Hierarchy - Query - 1 Table, 2 Levels : 
---
### Cubes :
...
```
---
### Cube Matrix for Hierarchy - Query - 1 Table, 2 Levels:
```mermaid
quadrantChart
title Cube Matrix
...
```
---
## Validation result for catalog Hierarchy - Query - 1 Table, 2 Levels
