# Documentation
### CatalogName : Hierarchy - Query - 1 Join
### Schema Hierarchy - Query - 1 Join : 
---
### Cubes :
...
```
---
### Cube Matrix for Hierarchy - Query - 1 Join:
```mermaid
quadrantChart
title Cube Matrix
...
```
---
## Validation result for catalog Hierarchy - Query - 1 Join
